...
class GamePlay(BaseState):
    def __init__(self):
        ...
        # Dùng để xác định xem người chơi thua hay thắng
        self.status = ""

        # Được sử dụng để tạm dừng trò chơi
        self.paused = False
    ...
    def startup(self, persistent):
        ...
        # Đặt lại ví trí cho Player
        self.player.rect.center = (self.player.x, self.player.y)

        # Đặt lại trạng thái/vị trí của quả bóng
    ...
    def update(self, dt):
        if not self.paused:
            # Đặt lại main_surface về vị trí mặc định (required for screenshake)
